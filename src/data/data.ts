...
export const EuropeColor = "#1DA1F2"
export const AsiaColor = "#FFD100"
export const AfricaColor = "#9146FF"
export const NorthAmericaColor = "#1f993e"
export const SouthAmericaColor = "#523200"
export const OceaniaColor = "#ff4500"

export const EuropeColorDark = "#18284e"
export const AsiaColorDark = "#806800"
export const AfricaColorDark = "#4100A3"
export const NorthAmericaColorDark = "#104C1F"
export const SouthAmericaColorDark = "#291900"
export const OceaniaColorDark = "#802200"
...
export const WinterYears: number[] = [1908, 1920, 1924, 1928, 1932, 1936, 1948, 1952, 1956, 1960, 1964, 1968, 1972, 1976, 1980, 1984, 1988, 1992, 1994, 1998, 2002, 2006, 2010, 2014]
...
export const AllNocs: string[] = ["AFG", "ALB", "ALG", "ASA", "AND", "ANG", "ANT", "ARG", "ARM", "ARU", "ANZ", "AUS", "AUT", "AZE", "BAH", "BRN", "BAN", "BAR", "BLR", "BEL", "BIZ", "BEN", "BER", "BHU", "BOL", "BIH", "BOT", "BRA", "BRU", "BUL", "BUR", "BDI", "CAM", "CMR", "CAN", "NFL", "CPV", "CAY", "CAF", "CHA", "CHI", "CHN", "HKG", "COL", "COM", "COK", "CRC", "CRO", "CUB", "AHO", "CYP", "BOH", "CZE", "TCH", "COD", "DEN", "DJI", "DMA", "DOM", "ECU", "EGY", "ESA", "GEQ", "ERI", "EST", "ETH", "FIJ", "FIN", "FRA", "GAB", "GAM", "GEO", "GER", "GHA", "CRT", "GRE", "GRN", "GUM", "GUA", "GUI", "GBS", "GUY", "HAI", "HON", "HUN", "ISL", "IND", "INA", "IRI", "IRQ", "IRL", "ISR", "ITA", "CIV", "JAM", "JPN", "JOR", "KAZ", "KEN", "KIR", "KOS", "KUW", "KGZ", "LAO", "LAT", "LIB", "LES", "LBR", "LBA", "LIE", "LTU", "LUX", "MKD", "MAD", "MAW", "MAS", "NBO", "MDV", "MLI", "MLT", "MHL", "MTN", "MRI", "MEX", "FSM", "MDA", "MON", "MGL", "MNE", "MAR", "MOZ", "MYA", "NAM", "NRU", "NEP", "NED", "NZL", "NCA", "NIG", "NGR", "PRK", "NOR", "OMA", "PAK", "PLW", "PLE", "PAN", "PNG", "PAR", "PER", "PHI", "POL", "POR", "PUR", "QAT", "CGO", "ROU", "RUS", "RWA", "SKN", "LCA", "VIN", "SAM", "SMR", "STP", "KSA", "SEN", "SCG", "SRB", "YUG", "SEY", "SLE", "SGP", "SVK", "SLO", "SOL", "SOM", "RSA", "KOR", "SSD", "ESP", "SRI", "SUD", "SUR", "SWZ", "SWE", "SUI", "SYR", "UAR", "TPE", "TJK", "TAN", "THA", "TLS", "TOG", "TGA", "TTO", "WIF", "TUN", "TUR", "TKM", "UGA", "GBR", "UKR", "UAE", "URU", "USA", "UZB", "VAN", "VEN", "VIE", "IVB", "ISV", "YAR", "YEM", "YMD", "ZAM", "RHO", "ZIM"]
